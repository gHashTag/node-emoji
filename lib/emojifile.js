...
emoji.data = {
  'custom-d83e-dd51': [['\uD83E\uDD51'], '', '', ['avocado'], 0, 0, 20, 0],
  'custom-d83e-ddc4': [['\uD83E\uDDC4'], '', '', ['garlic'], 0, 0, 21, 0],
  'custom-d83e-dd6e': [['\uD83E\uDD6E'], '', '', ['moon_cake'], 0, 0, 22, 0],
  'custom-d83e-ddc2': [['\uD83E\uDDC2'], '', '', ['salt'], 0, 0, 23, 0],
  'custom-d83c-df82': [['\uD83C\uDF82'], '', '', ['birthday'], 0, 0, 24, 0],
  'custom-d83c-df69': [['\uD83C\uDF69'], '', '', ['bagel'], 0, 0, 25, 0],
  'custom-d83e-ddc3': [['\uD83E\uDDC3'], '', '', ['beverage_box'], 0, 0, 26, 0],
  'custom-d83e-ddca': [['\uD83E\uDDCA'], '', '', ['ice_cube'], 0, 0, 27, 0],
  'custom-d83e-ddc6': [['\uD83E\uDDC6'], '', '', ['falafel'], 0, 0, 28, 0],
  'custom-d83e-ddc7': [['\uD83E\uDDC7'], '', '', ['waffle'], 0, 0, 29, 0],
  'custom-d83e-dd6c': [['\uD83E\uDD6C'], '', '', ['leafy_green'], 0, 0, 30, 0],
  'custom-d83e-ddc9': [['\uD83E\uDDC9'], '', '', ['mate_drink'], 0, 0, 31, 0],
  'custom-d83e-ddc1': [['\uD83E\uDDC1'], '', '', ['cupcake'], 0, 0, 32, 0],
  'custom-d83e-ddc8': [['\uD83E\uDDC8'], '', '', ['butter'], 0, 0, 33, 0],
  'custom-d83e-ddc5': [['\uD83E\uDDC5'], '', '', ['onion'], 0, 0, 34, 0],
  'custom-d83e-dd6a': [['\uD83E\uDD6A'], '', '', ['sandwich'], 0, 0, 35, 0],
  'custom-d83e-dd64': [['\uD83E\uDD64'], '', '', ['cup_with_straw'], 0, 0, 36, 0],
  '0023-fe0f-0e3': [['\u0023\uFE0F\u20E3', '\u0023\u20E3'], '\uE210', '\uDBBA\uDC2C', ['hash'], 0, 0, 15, 0],
  ...
  '1f46f-200d-2640-fe0f': [
    ...
    '',
    '',
    ['woman-with-bunny-ears-partying', 'dancers'],
    20,
    51,
    31,
    0
